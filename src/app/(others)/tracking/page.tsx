...
import { TrackingData } from "@/app/(others)/types/types";
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <div className="flex flex-col space-y-4">
              <label htmlFor="labelId" className="text-lg font-medium text-black-400">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-orange-400 text-white py-2 px-4 rounded-md hover:bg-orange-500 transition-colors disabled:bg-gray-400"
              >
          ...
          {trackingData && (
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md text-[#505977]">
              <h2 className="text-2xl font-bold mb-4 text-black">Tracking Details</h2>
